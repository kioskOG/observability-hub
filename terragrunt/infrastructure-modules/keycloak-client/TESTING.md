# Testing Guide: keycloak-client Module

This guide details the procedures to locally test, verify, troubleshoot, and validate the `keycloak-client` module (SAML + OIDC) and its enterprise extensions.

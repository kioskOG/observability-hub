...
inputs = {
  ...
  iam_role = {
    ...
    # IRSA role for Wazuh Agent on EC2 — allows polling CloudWatch Logs, listing
    # CloudTrail files, and fetching WAF/VPC Flow/Config/GuardDuty logs when configured.
    #WazuhCloudWatchLogsRole = {
    #  custom_policy = [
    #    "WazuhCloudWatchLogs"
    #  ]
    #  managed_policy = []
